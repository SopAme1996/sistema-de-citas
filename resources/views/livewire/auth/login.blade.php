            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                    <form wire:submit.prevent='store'>
                        ...
                        @endif
                        <div
                            class="input-group input-group-outline mt-3 @if (strlen($nickName ?? '') > 0) is-filled @endif">
                        ...
                        <p class="mt-4 text-sm text-center">
                            ...
                            <a href="{{ route('register') }}" class="text-primary text-gradient font-weight-bold">Registrate ahora mismo</a>
                        </p>
                        <p class="text-sm text-center">
                            ¿Olvidaste tu contraseña? Reseteala
