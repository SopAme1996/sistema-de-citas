                ...
                <form wire:submit.prevent='update'>
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input wire:model.lazy="user.nickName" type="text"
                        ...
                        <div class="mb-3 col-md-3 form-check form-switch">
                            <label for="flexSwitchCheckDefault">Status</label>
                            <div>
                                <input wire:model.lazy="user.status" class="form-control form-check-input p-2"
