...
<div class="card border border-2">
    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <div class="multisteps-form__progress">
                ...
                <button class="multisteps-form__progress-btn" type="button" title="colaboradores">COLABORADORES</button>
                ...
                <button class="multisteps-form__progress-btn" type="button" title="informacion">INFORMACION</button>
    ...
    <div class="card-body">
        <form class="multisteps-form__form" id="wizardCita">
            <!--single form panel-->
            <div class="multisteps-form__panel border-radius-xl bg-white js-active" id="ubicacion"
                                ...
                                <div class="card card-blog card-plain">
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <button type="button" class="btn btn-outline-primary btn-sm mb-0 sucursal"
                                                id="sucursal-{{ $sucursal->idSucursal }}">Seleccionar</button>
            ...
            <!--single form panel-->
            <div id="colaboradores" class="multisteps-form__panel border-radius-xl bg-white" data-animation="FadeIn">
                <div class="mb-3 ps-3">
            ...
            <!--single form panel-->
            <div id="servicio" class="multisteps-form__panel border-radius-xl bg-white" data-animation="FadeIn">
            ...
            <!--single form panel-->
            <div id="fechas" class="multisteps-form__panel border-radius-xl bg-white" data-animation="FadeIn">
